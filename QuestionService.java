...
public class QuestionService {
    ...
    public void playQuiz() {
        // this loop can be used to display all questions and written manually or we can use toString method that should be overridden in Question class using source action option.
